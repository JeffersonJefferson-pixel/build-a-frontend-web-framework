...
const TodoItem = defineComponent({
  ...
  render() {
    ...
    return isEditing ? this.renderInEditMode(edited) : this.renderInViewMode(original)
  },
    ...
    return h(
      ...
      [
        h(
          ...
          {
            on: {
              dblclick: () => this.updateState({ isEditing: true })
            }
          },
          [original]
        ),
        h(
          ...
          {
            on: {
              click: () => this.emit('remove', this.props.i)
            }
          },
          ['Done']
        )
